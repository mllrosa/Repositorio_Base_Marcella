...
class App:
    ...
    def create_circular_buttons(self):
        """Cria três botões circulares centralizados com URLs"""
        def open_url(e, url):
            import webbrowser
            webbrowser.open(url)
        ...
        return ft.Container(
            content=ft.Row([
                ft.IconButton(
                    ...
                    on_click=lambda e: open_url(e, "https://www.parnaiba.sp.gov.br"),
                    style=button_style
                ),
                ...
                ft.IconButton(
                    ...
                    icon_size=30,
                    tooltip="Notícias",
                    on_click=lambda e: open_url(e, "https://www.climatempo.com.br/previsao-do-tempo/cidade/264/santana-de-parnaiba-sp"),
                    style=button_style
                ),
                ...
                ft.IconButton(
                    ...
                    icon_size=30,
                    tooltip="Mapa",
                    on_click=lambda e: open_url(e, "https://www.google.com/maps/place/Santana+de+Parna%C3%ADba+-+SP"),
                    style=button_style
                ),
            ], 
    ...
    def main(self, page: ft.Page):
        ...
        circular1_buttons = self.create_circular_buttons()
        circular2_buttons = self.create_circular_buttons() 
        circular3_buttons = self.create_circular_buttons()
        ...
        content = ft.Column([
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    # Botões Circulares
                    circular1_buttons, circular2_buttons, circular3_buttons,
                    
                    # Espaço extra para permitir scroll até o final
        ...
        """função de rodar o carrosel automaticamente - CORRIGIDA"""
        ...
        def auto_play():
            while self.auto_play_enabled:
                ...
                if self.auto_play_enabled and page is not None:
                    self.carousel_index = (self.carousel_index + 1) % len(self.carousel_images)
                    # Usando page.update() diretamente em vez de run_task
                    update_carousel()
                    try:
                        page.update()
                    except:
