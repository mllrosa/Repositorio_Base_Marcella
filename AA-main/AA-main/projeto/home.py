...
def HomeView(page: ft.Page):
    ...
    from notificação import NotificacaoView
    ...
    def mudar_tela(num):
        page.views.clear()
        if num == 0:
            page.views.append(HomeView(page))  # Instanciando a classe
        elif num == 1:
            page.views.append(LoginView(page))  # Instanciando a classe
        elif num == 2:
            page.views.append(NotificacaoView(page))  # Instanciando a classe
        elif num == 3:
            page.views.append(PerfilView(page))  # Instanciando a classe
        page.update()
